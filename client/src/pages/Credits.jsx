        ...
        <div className='flex flex-wrap justify-center gap-8'>
            {plans.map((plan)=>(
                ...
                flex flex-col ${plan._id === "pro"? 'bg-purple-50 dark:bg-purple-900':'bg-white dark:bg-transparent'}`}>
                    ...
                    className='mt-6 bg-purple-500 hover:bg-purple-700 active:bg-purple-900 text-white font-medium py-2 rounded transition-colors cursor-pointer '>Buy Now</button>
